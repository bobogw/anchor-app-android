 ...
 *
 */
package com.newname.http.impl.auth;
...
import com.newname.http.Consts;
...
import com.newname.http.auth.ChallengeState;
import com.newname.http.auth.Credentials;
import com.newname.http.auth.MalformedChallengeException;
import com.newname.http.message.BasicHeaderValueFormatter;
import com.newname.http.message.BasicNameValuePair;
import com.newname.http.message.BufferedHeader;
...
import com.newname.http.util.CharArrayBuffer;
import com.newname.http.util.EncodingUtils;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    /**
     * @deprecated (4.2) Use {@link com.newname.http.auth.ContextAwareAuthScheme#authenticate(
     *   Credentials, HttpRequest, com.newname.http.protocol.HttpContext)}
     */
    @Override
    @Deprecated
     ...
     *
     * @throws com.newname.http.auth.InvalidCredentialsException if authentication credentials
