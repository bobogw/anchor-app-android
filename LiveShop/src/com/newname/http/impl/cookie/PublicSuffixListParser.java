...
import com.newname.http.conn.util.PublicSuffixList;

/**
 * Parses the list from <a href="http://publicsuffix.org/">publicsuffix.org</a>
 * and configures a PublicSuffixFilter.
 *
 * @deprecated (4.4) use {@link com.newname.http.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
@Immutable
...
public class PublicSuffixListParser {
    ...
    private final com.newname.http.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new com.newname.http.conn.util.PublicSuffixListParser();
    }
