...
import com.newname.http.conn.ssl.X509HostnameVerifier;

import com.newname.http.ConnectionReuseStrategy;
...
import com.newname.http.annotation.NotThreadSafe;
import com.newname.http.auth.AuthSchemeProvider;
import com.newname.http.client.AuthenticationStrategy;
import com.newname.http.client.BackoffManager;
import com.newname.http.client.ConnectionBackoffStrategy;
import com.newname.http.client.CookieStore;
import com.newname.http.client.CredentialsProvider;
import com.newname.http.client.HttpRequestRetryHandler;
import com.newname.http.client.RedirectStrategy;
import com.newname.http.client.ServiceUnavailableRetryStrategy;
import com.newname.http.client.UserTokenHandler;
import com.newname.http.client.config.AuthSchemes;
...
import com.newname.http.client.protocol.RequestExpectContinue;
...
import com.newname.http.config.ConnectionConfig;
import com.newname.http.config.Lookup;
import com.newname.http.config.RegistryBuilder;
import com.newname.http.config.SocketConfig;
import com.newname.http.conn.ConnectionKeepAliveStrategy;
import com.newname.http.conn.DnsResolver;
import com.newname.http.conn.HttpClientConnectionManager;
import com.newname.http.conn.SchemePortResolver;
import com.newname.http.conn.routing.HttpRoutePlanner;
import com.newname.http.conn.socket.ConnectionSocketFactory;
import com.newname.http.conn.socket.LayeredConnectionSocketFactory;
import com.newname.http.conn.socket.PlainConnectionSocketFactory;
import com.newname.http.conn.ssl.DefaultHostnameVerifier;
import com.newname.http.conn.ssl.SSLConnectionSocketFactory;
import com.newname.http.conn.util.PublicSuffixMatcher;
import com.newname.http.conn.util.PublicSuffixMatcherLoader;
import com.newname.http.cookie.CookieSpecProvider;
import com.newname.http.impl.NoConnectionReuseStrategy;
import com.newname.http.impl.auth.BasicSchemeFactory;
import com.newname.http.impl.auth.DigestSchemeFactory;
import com.newname.http.impl.auth.KerberosSchemeFactory;
import com.newname.http.impl.auth.NTLMSchemeFactory;
import com.newname.http.impl.auth.SPNegoSchemeFactory;
import com.newname.http.impl.conn.DefaultProxyRoutePlanner;
import com.newname.http.impl.conn.DefaultRoutePlanner;
import com.newname.http.impl.conn.DefaultSchemePortResolver;
import com.newname.http.impl.conn.PoolingHttpClientConnectionManager;
import com.newname.http.impl.conn.SystemDefaultRoutePlanner;
import com.newname.http.impl.execchain.BackoffStrategyExec;
import com.newname.http.impl.execchain.ClientExecChain;
import com.newname.http.impl.execchain.MainClientExec;
import com.newname.http.impl.execchain.ProtocolExec;
import com.newname.http.impl.execchain.RedirectExec;
import com.newname.http.impl.execchain.RetryExec;
import com.newname.http.impl.execchain.ServiceUnavailableRetryExec;
import com.newname.http.protocol.HttpProcessor;
import com.newname.http.protocol.HttpProcessorBuilder;
import com.newname.http.protocol.HttpRequestExecutor;
import com.newname.http.protocol.ImmutableHttpProcessor;
...
import com.newname.http.ssl.SSLContexts;
...
public class HttpClientBuilder {
     ...
     *   com.newname.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   com.newname.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link com.newname.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see com.newname.http.conn.util.PublicSuffixMatcher
     * @see com.newname.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   com.newname.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * com.newname.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   com.newname.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link com.newname.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link com.newname.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     *
     * @see com.newname.http.impl.client.CookieSpecRegistries
     *
     */
    ...
    /**
     * Assigns a map of {@link com.newname.http.client.entity.InputStreamFactory}s
     ...
     * @see com.newname.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "com.newname.http.client", getClass());
            }
        }
