...
public class VersionInfo {
     ...
     * @param pkg
     *            the package for which to load version information, for example "com.newname.http". The package name
