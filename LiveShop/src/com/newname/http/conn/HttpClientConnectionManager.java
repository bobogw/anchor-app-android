...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(com.newname.http.HttpClientConnection,
     *   com.newname.http.conn.routing.HttpRoute, int,
     *   com.newname.http.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(com.newname.http.HttpClientConnection,
     *   com.newname.http.conn.routing.HttpRoute,
     *   com.newname.http.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  com.newname.http.HttpClientConnection,
     *  com.newname.http.conn.routing.HttpRoute,
     *  com.newname.http.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     * </p>
     *
