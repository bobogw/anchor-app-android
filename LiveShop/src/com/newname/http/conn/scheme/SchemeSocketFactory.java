...
package com.newname.http.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link com.newname.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p>
     * Please note that {@link com.newname.http.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link com.newname.http.HttpHost} value used to resolve the address. The use of
     * {@link com.newname.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see com.newname.http.conn.HttpInetSocketAddress
     */
