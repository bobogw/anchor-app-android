...
package com.newname.http.client.config;
...
public class RequestConfig implements Cloneable {
    ...
    */
     ...
     *   com.newname.http.impl.conn.PoolingHttpClientConnectionManager#getValidateAfterInactivity()}
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated (4.4) Use {@link
         *   com.newname.http.impl.conn.PoolingHttpClientConnectionManager#setValidateAfterInactivity(int)}
         */
        @Deprecated
