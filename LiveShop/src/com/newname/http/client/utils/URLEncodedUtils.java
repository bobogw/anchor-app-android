...
package com.newname.http.client.utils;
...
import com.newname.http.message.TokenParser;
...
public class URLEncodedUtils {
     ...
     *            Encoding to use when decoding the parameters.
     *
     * @deprecated (4.4) use {@link #parse(com.newname.http.util.CharArrayBuffer, java.nio.charset.Charset, char...)}
     */
    @Deprecated
    public static void parse(
            final List <NameValuePair> parameters,
