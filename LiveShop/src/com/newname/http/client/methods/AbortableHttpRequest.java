...
import com.newname.http.conn.ConnectionReleaseTrigger;
...
public interface AbortableHttpRequest {
    ...
    /**
     * Sets the {@link com.newname.http.conn.ClientConnectionRequest}
     ...
     *
     * @see com.newname.http.conn.ClientConnectionManager
     */
     ...
     *   {@link com.newname.http.conn.ManagedClientConnection} itself.
     * If the request is already aborted, throws an {@link IOException}.
     */
     ...
     *
     * @see com.newname.http.client.HttpClient#execute(HttpUriRequest)
     * @see com.newname.http.client.HttpClient#execute(com.newname.http.HttpHost,
     *      com.newname.http.HttpRequest)
     * @see com.newname.http.client.HttpClient#execute(HttpUriRequest,
     *      com.newname.http.protocol.HttpContext)
     * @see com.newname.http.client.HttpClient#execute(com.newname.http.HttpHost,
     *      com.newname.http.HttpRequest, com.newname.http.protocol.HttpContext)
     */
    void abort();
